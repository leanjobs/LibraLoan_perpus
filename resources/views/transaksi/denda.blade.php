                ...
                <div class="col-12 mt-4">
                            ...
                            <div class="table-responsive p-0">
                                ...
                                <table class="table align-items-center mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <p class="text-xs text-secondary mb-0 ps-3">{{ $data->kode_pinjam }}</p>
                                            </td>
                                            <td>
                                                <p class="text-xs text-secondary mb-0 ps-3">{{ $data->tanggal_pinjam }}</p>
                                            </td>
                                            <td>
                                                <p class="text-xs text-secondary mb-0 ps-3">{{ $data->tanggal_kembali }}
                                                </p>
                                            </td>
                                            <td>
                                                <p class="text-xs text-secondary mb-0 ps-3">
                                                    {{ $data->tanggal_pengembalian }}</p>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <p class="text-xs text-secondary  ps-3">
                                                    Rp. {{ $data->denda >= 0 ? number_format($data->denda) : '-' }}</p>
                    ...
                    <div class="d-flex justify-content-end">
                        <form action="" method="" class="d-inline">
                            {{-- @csrf
                                @method('POST') --}}
                            <button type="submit" class="btn btn-warning mx-1">Confirm</button>
                        </form>
                    </div>
